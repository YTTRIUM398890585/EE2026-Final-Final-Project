...
#
# Generated by export_simulation on Tue Nov 14 22:42:23 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './canvasgrid_ram.sh' script.

./canvasgrid_ram.sh -reset_run
...
./canvasgrid_ram.sh -noclean_files

For more information on the script, please type './canvasgrid_ram.sh -help'.
