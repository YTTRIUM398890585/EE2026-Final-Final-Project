...
#
# Generated by export_simulation on Tue Nov 14 22:34:54 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './logicgate_rom.sh' script.

./logicgate_rom.sh -reset_run
...
./logicgate_rom.sh -noclean_files

For more information on the script, please type './logicgate_rom.sh -help'.
