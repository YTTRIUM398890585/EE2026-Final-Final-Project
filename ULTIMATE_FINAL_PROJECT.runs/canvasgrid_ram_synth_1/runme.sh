...
HD_PWD='C:/Users/Irwin/University/AY2023-2024/EE2026/xc7a35tcpg236-1_LAB_PROJECTS/ULTIMATE_FINAL_PROJECT/ULTIMATE_FINAL_PROJECT.runs/canvasgrid_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log canvasgrid_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source canvasgrid_ram.tcl
